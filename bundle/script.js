...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <li>\n    <div class=\"photo-card\">\n      <img\n        src=\""
    ...
    + "\"\n        alt=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"tags") || (depth0 != null ? lookupProperty(depth0,"tags") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"tags","hash":{},"data":data,"loc":{"start":{"line":6,"column":13},"end":{"line":6,"column":21}}}) : helper)))
    + "\"\n        height=\"480\"\n        width=\"640\"\n      />\n\n      <div class=\"stats\">\n        <p class=\"stats-item\">\n          <i class=\"material-icons\">thumb_up</i>\n          "
    + alias4(((helper = (helper = lookupProperty(helpers,"likes") || (depth0 != null ? lookupProperty(depth0,"likes") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"likes","hash":{},"data":data,"loc":{"start":{"line":14,"column":10},"end":{"line":14,"column":19}}}) : helper)))
    + "\n        </p>\n        <p class=\"stats-item\">\n          <i class=\"material-icons\">visibility</i>\n          "
    + alias4(((helper = (helper = lookupProperty(helpers,"views") || (depth0 != null ? lookupProperty(depth0,"views") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"views","hash":{},"data":data,"loc":{"start":{"line":18,"column":10},"end":{"line":18,"column":19}}}) : helper)))
    + "\n        </p>\n        <p class=\"stats-item\">\n          <i class=\"material-icons\">comment</i>\n          "
    + alias4(((helper = (helper = lookupProperty(helpers,"comments") || (depth0 != null ? lookupProperty(depth0,"comments") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"comments","hash":{},"data":data,"loc":{"start":{"line":22,"column":10},"end":{"line":22,"column":22}}}) : helper)))
    + "\n        </p>\n        <p class=\"stats-item\">\n          <i class=\"material-icons\">cloud_download</i>\n          "
    + alias4(((helper = (helper = lookupProperty(helpers,"downloads") || (depth0 != null ? lookupProperty(depth0,"downloads") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"downloads","hash":{},"data":data,"loc":{"start":{"line":26,"column":10},"end":{"line":26,"column":23}}}) : helper)))
    + "\n        </p>\n      </div>\n    </div>\n  </li>\n";
  ...
  return ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),depth0,{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":4},"end":{"line":31,"column":11}}})) != null ? stack1 : "");
},"useData":true});
...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[0].use[1]!./node_modules/css-loader/dist/cjs.js!./src/styles.css
...
// EXTERNAL MODULE: ./src/templates/template.hbs
var template = __webpack_require__(420);
var template_default = /*#__PURE__*/__webpack_require__.n(template);
// EXTERNAL MODULE: ./src/templates/form.hbs
var templates_form = __webpack_require__(42);
var form_default = /*#__PURE__*/__webpack_require__.n(templates_form);
;// CONCATENATED MODULE: ./src/js/refs.js

document.body.insertAdjacentHTML("afterbegin", form_default()());
...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[0].use[1]!./node_modules/css-loader/dist/cjs.js!./node_modules/@pnotify/core/dist/PNotify.css
var dist_PNotify = __webpack_require__(970);
...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[0].use[1]!./node_modules/css-loader/dist/cjs.js!./node_modules/@pnotify/mobile/dist/PNotifyMobile.css
var dist_PNotifyMobile = __webpack_require__(327);
var dist_PNotifyMobile_default = /*#__PURE__*/__webpack_require__.n(dist_PNotifyMobile);
;// CONCATENATED MODULE: ./node_modules/@pnotify/mobile/dist/PNotifyMobile.css
...
var PNotifyMobile_options = {};

PNotifyMobile_options.styleTagTransform = (styleTagTransform_default());
PNotifyMobile_options.setAttributes = (setAttributesWithoutAttributes_default());

      PNotifyMobile_options.insert = insertBySelector_default().bind(null, "head");
    
PNotifyMobile_options.domAPI = (styleDomAPI_default());
PNotifyMobile_options.insertStyleElement = (insertStyleElement_default());

var PNotifyMobile_update = injectStylesIntoStyleTag_default()((dist_PNotifyMobile_default()), PNotifyMobile_options);




       /* harmony default export */ const mobile_dist_PNotifyMobile = ((dist_PNotifyMobile_default()) && (dist_PNotifyMobile_default()).locals ? (dist_PNotifyMobile_default()).locals : undefined);

// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[0].use[1]!./node_modules/css-loader/dist/cjs.js!./node_modules/@pnotify/core/dist/Material.css
var Material = __webpack_require__(915);
...
;// CONCATENATED MODULE: ./src/js/galleryClass.js
...
var Gallery = function Gallery(_ref, API_KEY, template) {
  var _this = this;

  var form = _ref.form,
      input = _ref.input,
      gallery = _ref.gallery,
      loadBtn = _ref.loadBtn,
      clearPageBtn = _ref.clearPageBtn;

  _classCallCheck(this, Gallery);

  _defineProperty(this, "addListeners", function () {
    _this.form.addEventListener("submit", _this.onSubmitForm);

    _this.clearPageBtn.addEventListener("click", _this.onClearPageBtn);

    _this.loadBtn.addEventListener("click", _this.onLoadClick);
  });

  _defineProperty(this, "onSubmitForm", function (event) {
    event.preventDefault();
    var query = event.target.elements.query.value;

    if (query.toLowerCase() === _this.query.toLowerCase()) {
      _this.page += 1;
    } else {
      _this.query = query;
      _this.page = 1;
  ...
  _defineProperty(this, "onClearPageBtn", function (event) {
    event.preventDefault();
    _this.gallery.innerHTML = "";
    _this.input.value = "";
    _this.page = 0;
    _this.query = "";
  });

  _defineProperty(this, "onLoadClick", function () {
    _this.page += 1;

    _this.renderPage(_this.query);
  });

  _defineProperty(this, "renderPage", function (query) {
    var URL = "https://pixabay.com/api/?image_type=photo&orientation=horizontal&q=".concat(query, "&page=").concat(_this.page, "&per_page=12&key=").concat(_this.API_KEY);
    return fetch(URL).then(function (res) {
      return res.json();
    }).then(function (response) {
      if (!response.hits.length) {
        (0,PNotify.alert)({
          text: "Cant find pictures by \"".concat(_this.query, "\"\n                        try again"),
          stack: myStack
        });
      }

      _this.gallery.insertAdjacentHTML("beforeend", _this.template(response.hits));
    })["catch"](function (err) {
...
var API_KEY = '22979359-6025158715709856931145b12';
new Gallery(refs, API_KEY, (template_default())).addListeners();
})();
